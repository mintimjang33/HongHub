...
- **오프닝 훅 공식**: 대본은 반드시 "여기 정신 나간 [구체적인 소품/작은 사물]을(를) [간단한 동작]" 같은 형태로 시작해줘.
  ...
  본 주제로 넓혀가는 방식이야. (예: "여기 정신 나간 못을 망치로 때려 박으면...", "이 남자는 3천만 원짜리 금괴를
  망치로 부었는데요", "초기 철판을 이어붙이려던 인간들은 제정신이 아니었습니다") 4번 분석의 대본 패턴에 이 공식이
  이미 나와 있으니 그대로 따라줘 — 절대 생략하지 마.
