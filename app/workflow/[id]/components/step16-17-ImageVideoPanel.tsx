...
1. 비주얼 톤앤매너 (2026-09-10 강화 — 씬마다 화풍이 다른 사람이 그린 것처럼 갈라지는 문제 발견 후 재보강): "A single consistent art style, 2D flat vector illustration, simple Korean webtoon comic style, solid flat colors, crisp black line art, no shading, no gradients, bright plain solid-color background"로 통일한다. 모든 캐릭터는 예외 없이 스틱맨 몸(얇은 선 팔다리 + 단순한 동그란 머리) 비율로만 그린다 — 정상적인 인체 비율(어깨 넓은 몸통, 상세한 손가락·근육 등)로 그리지 않는다. 다음 요소는 프롬프트에 절대 등장시키지 않는다: 3D rendering, CGI, photorealism, photography, cinematic lighting, gradients, heavy shading, watercolor or oil-painting texture, macro close-up realism, dark moody atmosphere, film-noir style.
